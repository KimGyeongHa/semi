...
<form action="review_writeok.jsp">
	<div class="review_write">
		...
		<div class="review_evaluate">
			<table>
				<tr>
					<td><img src="../images/face1.PNG" alt="" />맛있어요</td>
					<td><img src="../images/face2.PNG" alt="" />괜찮아요</td>
					<td><img src="../images/face3.PNG" alt="" />별로예요</td>	
				</tr>
				<tr>
				...
				<a href="../aclass/restuarantok.jsp"><input type="button" value="돌아가기" /></a>
