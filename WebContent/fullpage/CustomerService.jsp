...
<div class="wrapper">
	...
	<table>
		...
		<tr>
			<td><%=vo.getBno() %></td>
			<td><a href="Cusdetail.jsp?bno=<%=vo.getBno()%>"><%=vo.getTitle()%></a></td>
		...
		<tr style="height: 41px;">
			...
			<td id="writer" colspan="5"><a href="../fullpage/Cuswriter.jsp"><input type="button" value="글쓰기" /></a>
	...
	<tr style="height: 41px;">
			...
			%>
				<a href="CustomerService.jsp?cp=<%= i %>"><%=i %></a>
			<% 	
				}
